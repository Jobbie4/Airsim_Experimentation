...
class Drone_FTP_Cam_loop:
    ...
    def __init__(self):
        ...
        self.data_dir= "C:/Users/ericu/Documents/Airsim_Build/data"
    ...
    def execute(self):
        ...
        IMULoop=RepeatThread.Thread(self.data_dir) 
        ...
        IMULoop.start_odometry_callback_thread()
        ...
        IMULoop.pause_odometry_callback_thread()
        self.client.simPause(True)
        time.sleep(2) #paused
        CameraLoop.unpause_image_callback_thread()
        IMULoop.unpause_odometry_callback_thread()
        ...
        IMULoop.stop_odometry_callback_thread()
    def stop(self):
