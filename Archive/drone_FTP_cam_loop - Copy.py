...
class Drone_FTP_Cam_loop:
    ...
    def execute(self):
        ...
        self.client.moveToPositionAsync(-43.70, 0, -10, 5).join()
        self.client.hoverAsync() 
        self.client.moveToPositionAsync(56.00, 0, -10, 5).join()
        self.client.hoverAsync().join()
        self.client.moveToPositionAsync(56.00, 75.00, -10, 5).join()
        self.client.hoverAsync().join()
        self.client.moveToPositionAsync(-43.70, 75.00, -10, 5).join()
        self.client.hoverAsync().join()
        self.client.moveToPositionAsync(-43.70, 0, -10, 5).join()
